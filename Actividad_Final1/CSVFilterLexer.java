...
public class CSVFilterLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "K_BETWEEN", "K_AND", "K_IN", "K_LIKE", "K_WHERE", "AGGR_FUNC", 
			"BOOLEAN", "FLOAT", "LOGICAL_OP", "OPERATOR", "STRING", "INT", "COMMENT", 
			"WS"
		};
	}
	...
	public CSVFilterLexer(CharStream input) {
		super(input);
